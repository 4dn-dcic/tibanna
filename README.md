...
Tibanna is a software tool that helps you run genomic pipelines on Amazon cloud (AWS). It is also a main workflow management system used by the 4DN DCIC (4D Nucleome Data Coordination and Integration Center).
