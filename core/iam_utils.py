...
def create_role_for_bucket(iam, tibanna_policy_prefix, bucket_policy_name):
    client = iam.meta.client
    bucket_role_name = tibanna_policy_prefix + '_s3'
...
def create_role_for_run_task_awsem(iam, tibanna_policy_prefix,
        cloudwatch_policy_name, bucket_policy_name, list_policy_name, passrole_policy_name):
    client = iam.meta.client
...
def create_role_for_check_task_awsem(iam, tibanna_policy_prefix,
...
def create_user_group(iam, group_name, bucket_policy_name):
    client = iam.meta.client
...
def create_tibanna_iam(account_id, bucket_names, user_group_name):
    ...
    create_role_for_run_task_awsem(iam, tibanna_policy_prefix,
        cloudwatch_policy_name, bucket_policy_name, list_policy_name, passrole_policy_name)
    create_role_for_check_task_awsem(iam, tibanna_policy_prefix,
        cloudwatch_policy_name, bucket_policy_name)
    # create IAM group for users who share permission
    create_user_group(iam, tibanna_policy_prefix, bucket_policy_name)
    return tibanna_policy_prefix
