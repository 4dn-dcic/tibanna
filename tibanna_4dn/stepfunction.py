...
class StepFunctionPony(StepFunctionUnicorn):
    ...
    @property
    def sfn_name(self):
        return 'tibanna_pony' + self.lambda_suffix
    ...
    def sfn_state_defs(self):
        state_defs = {
            "StartRunAwsem": {
                "Type": "Task",
                "Resource": self.lambda_arn_prefix + "start_run_awsem" + self.lambda_suffix,
            ...
            "UpdateFFMetaAwsem": {
                "Type": "Task",
                "Resource": self.lambda_arn_prefix + "update_ffmeta_awsem" + self.lambda_suffix,
