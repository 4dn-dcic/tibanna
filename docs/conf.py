...
latex_documents = [
    (master_doc, 'tibanna.tex', 'tibanna Documentation',
     'Mirny Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'tibanna', 'tibanna Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tibanna', 'tibanna Documentation',
     author, 'tibanna', 'One line description of project.',
     'Miscellaneous'),
]
